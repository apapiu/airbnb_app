...
#MAPS RELATED STUFF:
#~~~~~~~~~~~~~~~~~~~
def get_nbds(new_descp, knn, model, train):
    """
...
def get_heat_map(descp, knn, model, train):
    ...
    map_osm.add_children(plugins.HeatMap(temp, min_opacity = 0.45, radius = 35, blur = 30,
...
def add_heat_layer(mapa, descp, knn, model, train, scale=1):
    ...
    mapa.add_children(plugins.HeatMap(temp, min_opacity = 0.45, radius = 35, blur = 30,
